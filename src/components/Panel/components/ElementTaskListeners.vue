    ...
    setup: function () {
      ...
      const saveTaskListener = async () => {
        ...
        switch (newListener.value.type) {
          case 'class':
            newListener.value.script = undefined
            newListener.value.delegateExpression = undefined
            newListener.value.expression = undefined
            break
          case 'expression':
            newListener.value.script = undefined
            newListener.value.delegateExpression = undefined
            newListener.value.class = undefined
            break
